...
/singleton/origin_item/origin/explorer
	...
	important_information = "Dionae from this cluster tend to come in every form and shape, but all share the disgust of light, and are capable of being sustained on less radiation alone than a regular diona."
...
/singleton/origin_item/origin/explorer/on_apply(mob/living/carbon/human/H)
	If(H.DS)
...
/singleton/origin_item/origin/harvester
	...
	possible_accents = list(ACCENT_ARUSHA)
	possible_citizenships = list(CITIZENSHIP_NONE, CITIZENSHIP_BIESEL, CITIZENSHIP_COALITION)
...
/singleton/origin_item/origin/serz
	...
	possible_accents = list(ACCENT_ARUSHA, ACCENT_VOIDSONG, ACCENT_CRIMSONSONG)
	possible_citizenships = list(CITIZENSHIP_NONE, CITIZENSHIP_BIESEL, CITIZENSHIP_COALITION)
